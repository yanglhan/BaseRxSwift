...
class YYBaseTabBarController: UITabBarController {
    ...
    private func initializes() {
     ...
     private func setupChildVC() {
            ...
            let vc1 = YYHomeViewController()
            let vc2 = YYLiveViewController()
            let vc3 = YYShortVideoViewController()
            let vc4 = YYMineViewController()
    ...
    extension YYBaseTabBarController {
        ...
        private func createChildController(_ vc: UIViewController?,
            ...
            if let rootVC = vc {
                ...
                // nav
                let nav = YYBaseNavigationController(rootViewController: rootVC)
                addChild(nav)
            }
        }
